...
mapping = {"Ave": "Avenue", "Ave.": "Avenue", "Cir": "Circle", "CIrcle": "Circle", "Ct": "Court", "Dr": "Drive",
           ...
           "W": "West", "W.": "West", "Blvd": "Boulevard", "Pky" :"Parkway"}
...
def update_postalcode(postalcode):
    ...
    if re.findall(r'^\d{5}$', postalcode): # 5 digits
        valid_postalcode = postalcode
        return valid_postalcode
    elif re.findall(r'(^\d{5})-\d{4}$', postalcode): # 9 digits
        valid_postalcode = re.findall(r'(^\d{5})-\d{4}$', postalcode)[0]
        return valid_postalcode
    elif re.findall(r'NC\s*\d{5}', postalcode): # with state code NC
        valid_postalcode =re.findall(r'\d{5}', postalcode)[0]  
        return valid_postalcode  
    else:
        return None 
